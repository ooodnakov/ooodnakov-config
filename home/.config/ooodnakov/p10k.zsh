# Generated by Powerlevel10k configuration wizard on 2026-04-07 at 19:59 MSK.
...
() {
  ...
  if [[ "${OOOCONF_PROMPT_STYLE:-verbose}" == concise ]]; then
    typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir vcs prompt_char)
    typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time virtualenv time)
    typeset -g POWERLEVEL9K_PROMPT_ADD_NEWLINE=false
    ...
    typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=36
    typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=24
  ...
  # Optional theme tweaks driven by oooconf.
  # These are intentionally minimal and only override a few high-impact colors.
  case "${OOOCONF_THEME:-}" in
    gruvbox)
      ...
      typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=142
